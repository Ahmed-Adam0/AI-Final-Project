...
namespace Graduation_infrastructure.Migrations
{
    ...
    [Migration("20260707130415_AddVendorWalletAndWithdrawal")]
    partial class AddVendorWalletAndWithdrawal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Graduation_domain.Entities.GenerateImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("EmptyRoom")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("GenerateImageUrl")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("generateImage");
                    ...
                    b.ToTable("generateImages", (string)null);
                });
            ...
            modelBuilder.Entity("Graduation_domain.Entities.OrderReviewImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OrderReviewImages", (string)null);
                });

            modelBuilder.Entity("Graduation_domain.Entities.PaymentMilestone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("VendorOrderId", "MilestoneStatus")
                        .IsUnique();
            ...
            modelBuilder.Entity("Graduation_domain.Entities.Product", b =>
                {
                    ...
                    b.Property<string>("Product3DModelUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Graduation_domain.Entities.ShowcaseHotspot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ShowcaseSlideId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ShowcaseSlideId");

                    b.ToTable("ShowcaseHotspots", (string)null);
                });
            ...
            modelBuilder.Entity("Graduation_domain.Entities.VendorOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Graduation_domain.Entities.VendorOrderStatusHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VendorOrderStatusHistories");
                });
            ...
            modelBuilder.Entity("Graduation_domain.Entities.VendorWallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Graduation_domain.Entities.VendorWithdrawal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VendorWithdrawals", (string)null);
                });
            ...
            modelBuilder.Entity("Graduation_domain.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("Graduation_domain.Entities.VendorOrder", "VendorOrder")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Graduation_domain.Entities.PaymentMilestone", b =>
                {
                    b.HasOne("Graduation_domain.Entities.PaymentTransaction", "PaymentTransaction")
            ...
            modelBuilder.Entity("Graduation_domain.Entities.ShowcaseHotspot", b =>
                {
                    ...
                    b.HasOne("Graduation_domain.Entities.ShowcaseSlide", "ShowcaseSlide")
                        .WithMany("Hotspots")
                        .HasForeignKey("ShowcaseSlideId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Graduation_domain.Entities.VendorOrder", b =>
                {
                    b.HasOne("Graduation_domain.Entities.Order", "MasterOrder")
            ...
            modelBuilder.Entity("Graduation_domain.Entities.VendorWallet", b =>
                {
                    b.HasOne("Graduation_domain.Entities.Workshop", "Workshop")
                        .WithOne("Wallet")
                        .HasForeignKey("Graduation_domain.Entities.VendorWallet", "WorkshopId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Graduation_domain.Entities.Order", b =>
                {
                    ...
                    b.Navigation("OrderReviewImages");
