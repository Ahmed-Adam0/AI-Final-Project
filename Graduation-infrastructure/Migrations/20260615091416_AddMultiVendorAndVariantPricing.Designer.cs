...
namespace Graduation_infrastructure.Migrations
{
    ...
    [Migration("20260615091416_AddMultiVendorAndVariantPricing")]
    partial class AddMultiVendorAndVariantPricing
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Graduation_domain.Entities.ProductVariant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Graduation_domain.Entities.ProductVariantAttributeValue", b =>
                {
            ...
            modelBuilder.Entity("Graduation_domain.Entities.VendorProductListing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductId", "WorkshopId")
                        .IsUnique();

                    b.ToTable("VendorProductListings", (string)null);
                });
            ...
            modelBuilder.Entity("Graduation_domain.Entities.CartItem", b =>
                {
                    ...
                    b.HasOne("Graduation_domain.Entities.ProductVariant", "ProductVariant")
                        .WithMany()
            ...
            modelBuilder.Entity("Graduation_domain.Entities.ProductVariant", b =>
                {
                    b.HasOne("Graduation_domain.Entities.VendorProductListing", "Listing")
                        .WithMany("Variants")
            ...
            modelBuilder.Entity("Graduation_domain.Entities.ProductVariantAttributeValue", b =>
                {
                    b.HasOne("Graduation_domain.Entities.ProductAttributeValue", "AttributeValue")
                        .WithMany("VariantAttributeValues")
                        .HasForeignKey("AttributeValueId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Graduation_domain.Entities.ProductVariant", "Variant")
                        .WithMany("VariantAttributeValues")
